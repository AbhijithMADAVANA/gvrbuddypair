...
class DatingSubscription(models.Model):
    PLAN_CHOICES = [
        ('daily', 'Daily'),
        ('weekly', 'Weekly'),
        ('monthly', 'Monthly'),
    ...
    class Meta:
        verbose_name = "DatingSubscription"
        verbose_name_plural = "DatingSubscriptions"
...
class Payment(models.Model):
    ...
    subscription_plan = models.ForeignKey(DatingSubscription, related_name="sub_plan", on_delete=models.CASCADE)
